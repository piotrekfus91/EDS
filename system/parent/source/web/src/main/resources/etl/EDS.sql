SET search_path = eds;
DROP TABLE IF EXISTS eds.comment CASCADE;
DROP TABLE IF EXISTS eds.resource_group CASCADE;
DROP TABLE IF EXISTS eds.directory CASCADE;
DROP TABLE IF EXISTS eds.tag CASCADE;
DROP TABLE IF EXISTS eds.mime_type CASCADE;
DROP TABLE IF EXISTS eds.document CASCADE;
DROP TABLE IF EXISTS eds."user" CASCADE;
DROP TABLE IF EXISTS eds.document_tag CASCADE;
DROP TABLE IF EXISTS eds.resource_group_directory CASCADE;
DROP TABLE IF EXISTS eds.resource_group_document CASCADE;
DROP SEQUENCE IF EXISTS eds.resource_group_seq;
DROP SEQUENCE IF EXISTS eds.directory_seq;
DROP SEQUENCE IF EXISTS eds.tag_seq;
DROP SEQUENCE IF EXISTS eds.comment_seq;
DROP SEQUENCE IF EXISTS eds.document_seq;
DROP SEQUENCE IF EXISTS eds.user_seq;
DROP SEQUENCE IF EXISTS eds.mime_type_seq;
DROP SEQUENCE IF EXISTS eds.user_seq;
DROP SEQUENCE IF EXISTS eds.comment_seq;
DROP SEQUENCE IF EXISTS eds.resource_group_seq;
DROP SEQUENCE IF EXISTS eds.directory_seq;
...
DROP SEQUENCE IF EXISTS eds.tag_seq;
DROP SEQUENCE IF EXISTS eds.document_seq;
DROP SCHEMA IF EXISTS eds;
CREATE SCHEMA eds;
CREATE SEQUENCE eds.user_seq NO MINVALUE NO MAXVALUE START WITH 1;
CREATE SEQUENCE eds.comment_seq NO MINVALUE NO MAXVALUE START WITH 1;
CREATE SEQUENCE eds.resource_group_seq NO MINVALUE NO MAXVALUE START WITH 1;
CREATE SEQUENCE eds.directory_seq NO MINVALUE NO MAXVALUE START WITH 1;
CREATE SEQUENCE eds.mime_type_seq NO MINVALUE NO MAXVALUE START WITH 1;
CREATE SEQUENCE eds.tag_seq NO MINVALUE NO MAXVALUE START WITH 1;
CREATE SEQUENCE eds.document_seq NO MINVALUE NO MAXVALUE START WITH 1;
